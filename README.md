A Terraform/CX as Code remote module for the following Genesys Cloud public API operation: Set Queue Membership
...
```hcl
module "data_action" {
    source             = "git::https://github.com/GenesysCloudDevOps/public-api-set-queue-membership-data-action-module.git?ref=v1.0.0"
    action_name        = "Set Queue Membership"
